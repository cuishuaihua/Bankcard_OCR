...
if __name__ == '__main__':
    train_line=0
    for index, line in enumerate(open("data_train.txt", 'r')):
        train_line+=1
    print("训练样本：",train_line)
    test_line=0
    for index, line in enumerate(open("data_test.txt", 'r')):
        test_line+=1
    print("测试样本：", test_line)
    ...
    model.fit_generator(train_loader,
    	steps_per_epoch = train_line // batch_size,
    	epochs = 20,
    	initial_epoch = 0,
    	validation_data = test_loader,
    	validation_steps = test_line // batch_size,
