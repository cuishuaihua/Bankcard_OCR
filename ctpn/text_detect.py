...
def text_detect(img):
    ...
    # print("=====scores, boxes, img===========",scores, boxes, img, scale)

    text_recs, img_drawed = draw_boxes(img, boxes, scale) #在原图画框
    # text_recs：文本框位置（列表形式），
    #img_drawed为 在原图上标注的图片
